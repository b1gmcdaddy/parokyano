    ...
    >
      ...
      <DialogContent>
        <Grid container spacing={1} justifyContent={"center"}>
            ...
            <Grid item sm={12}>
                <Typography variant='subtitle2' sx={{textAlign: 'center', marginTop: '1rem'}}>
                Please wait for the parish to verify if the requested date and time is possible. <br/>
                We will communicate with you once the request has been approved and for other purposes.
                </Typography>
            </Grid>
