...
const BlessingPending = ({open, handleClose, request}) => {
  ...
  const [preferredPriest, setPreferredPriest] = useState(
          ...
          <Grid container justifyContent={"center"} spacing={2}>
            ...
            <Grid item sm={3}>
              ...
              <TextField
                fullWidth
                select
                value={request.preferred_priest}
                sx={TextFieldStyle}>
                <MenuItem value="1">Priest A</MenuItem>
                <MenuItem value="2">Priest B</MenuItem>
              </TextField>
            </Grid>
            <Grid item sm={3}>
              <label>Date:</label>
