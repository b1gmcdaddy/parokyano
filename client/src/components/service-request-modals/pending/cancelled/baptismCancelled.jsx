...
const BaptismCancelled = ({ open, data, handleClose }) => {
  ...
  const fetchBaptismDetails = async (id) => {
    try {
      ...
      setDetails({
        birthCert: response.data.result[0].birthCert || 0,
          ...
          <Box sx={modalContentStyle}>
            <Grid container justifyContent={"center"} spacing={0.8}>
              ...
              <Grid item sm={4}>
                ...
                <TextField
                  disabled
                  value={util.formatDate(data.preferred_date)}
                  fullWidth
                  sx={TextFieldStyleDis}
                />
              </Grid>
              ...
              <Grid item sm={4}>
                ...
                <TextField
                  ...
                  sx={TextFieldStyleDis}
                  value={
                    priests.find((priest) => priest.priestID === data.priest_id)
                      ?.first_name +
                    " " +
                    priests.find((priest) => priest.priestID === data.priest_id)
                      ?.last_name
              ...
              <Grid item sm={4}>
                ...
                <TextField
                  disabled
                  value={util.formatTime(data.preferred_time)}
                  fullWidth
                  sx={TextFieldStyleDis}
                />
              </Grid>
