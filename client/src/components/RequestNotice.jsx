...
const RequestNotice = ({ open, onClose }) => {
  return (
    <Dialog
      open={open}
      onClose={onClose}
    ...
    >
      ...
      <DialogContent>
        <Box id="alert-dialog-description">
          ...
          <h3 className='text-center px-3'>Welcome to Gethseman Parish!<br/>
          ...
          <ol className='mt-3 px-4 text-justify mb-3'>
            ...
            <p>&nbsp;&nbsp;&nbsp;Visit or call the parish office in the area where you reside, specifically the area of where you are registered as a voter. 
        ...
        <FormGroup style={{justifyContent: 'center', alignItems: 'center' }}>
            <FormControlLabel control={<Checkbox defaultChecked />} label="I have read
            and understood this policy statement" style={{fontFamily:'tahoma'}}/>
        </FormGroup>
      </DialogContent>
      <DialogActions>
