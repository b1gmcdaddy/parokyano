...
import { Container, Grid, TextField, MenuItem, Box, Button, RadioGroup, FormControlLabel, Radio, Typography } from '@mui/material';
...
const Souls = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const addMoreSouls = () => {
      setFormData({...formData.intention_details, intention_details: [...formData.intention_details, '']})
    }
                ...
                <form onSubmit={handleSubmit}>
                    <Grid container spacing={4}>
                        ...
                        <Grid container justifyContent={'center'} alignItems={'center'} direction={'column'}>
                          ...
                          <Button type="button" onClick={addMoreSouls}>Add Name</Button>
                        </Grid>
