      ...
      <div className='max-w-[1440px] mx-auto mt-8'>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={12} md={3} style={{ position: 'relative' }}>
            ...
            <img src={imageHeader} alt="Service 3" onClick={() => navigate('/mass-selection')} className="object-cover md:h-[186px] w-full rounded-lg shadow-md shadow-gray-500 cursor-pointer
             hover:scale-105 duration-300 hover:opacity-85" />
