                ...
                <form>
                    <Grid container spacing={4}>
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <TextField fullWidth variant="outlined" size="small" sx={inputstlying}
                            name="spouse_firstName" onChange={handleChange} autoComplete="off" required />
                        </Grid>
                        <Grid item xs={12} sm={4}>
                            <label><span className="text-red-600 font-bold">*</span>Spouse's Middle Name:</label>
                            <TextField fullWidth variant="outlined" size="small" sx={inputstlying} 
                            name="spouse_middleName" onChange={handleChange} autoComplete="off" required />
                        </Grid>
                        <Grid item xs={12} sm={4}>
                            <label><span className="text-red-600 font-bold">*</span>Spouse's Last Name:</label>
                            <TextField fullWidth variant="outlined" size="small" sx={inputstlying}
                            name="spouse_lastName" onChange={handleChange} autoComplete="off" required />
                        </Grid>
                        <Grid item xs={12} sm={4}>
                            <label><span className="text-red-600 font-bold">*</span>Date of Marriage:</label>
                            <TextField fullWidth variant="outlined" size="small" sx={inputstlying}
                            name="father_name" onChange={handleChange} autoComplete="off" type="date" required />
                        </Grid>
                        <Grid item xs={12} sm={4}>
