      ...
      <Container maxWidth="lg" sx={{ marginBottom: "60px" }}>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={4}>
              <label>
                <span className="text-red-600 font-bold">*</span>Spouse's First
                Name:
              </label>
              <TextField
                fullWidth
            ...
            <Grid item xs={12} sm={4}>
              <label>
                <span className="text-red-600 font-bold"></span>Spouse's Middle
                Name:
              </label>
              <TextField
                fullWidth
            ...
            <Grid item xs={12} sm={4}>
              <label>
                <span className="text-red-600 font-bold">*</span>Spouse's Last
                Name:
              </label>
              <TextField
                fullWidth
            ...
            <Grid item xs={12} sm={4}>
              <label>
                <span className="text-red-600 font-bold">*</span>Date of
                Marriage:
              </label>
