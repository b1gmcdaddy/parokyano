    ...
    useEffect(() => {
        const getApprovedReqs = async () => {
            try {
                ...
                setApprovedReqs(res.data.result); 
            } catch (err) {
                console.error('error retrieving approved reqs', err);
            }
        }
        getApprovedReqs();
    }, [])
                ...
                <Table stickyHeader aria-label="custom table" sx={{borderCollapse: 'separate', borderSpacing: 0, sm: {minWidth: 650},}}>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell sx={{textAlign: 'center', border: 'none'}}>Approved Date</TableCell>
                            <TableCell sx={{textAlign: 'center', border: 'none'}}>Priest Assigned</TableCell>
